...
from InBot.helper.utils import rankey
from InBot import logs_channel_update, human_hour_readable
from InBot import sayulogs
from InBot.__vars__ import BOT_NAME
...
def sayureports(extra_info: str = "", reason: Any = None):
    ...
    for _ in streport:
        _txt += _
    if reason:
        sayulogs.error(reason, exc_info=exc_info, extra={"hhr": human_hour_readable()})
        _txt += f"\n\nREASON:\n{reason}\n"
