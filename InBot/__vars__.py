...
# Data
BOT_NAME = config("BOT_NAME", default="InBot")
API_ID = config("API_ID", default=None, cast=int)
API_HASH = config("API_HASH", default=None)
BOT_TOKEN = config("BOT_TOKEN", default=None)
BOT_ALIAS = config("BOT_ALIAS", default="AnubisTestsBot")
# Channels id
UTC = config("UTC", default="-6")
CHANNEL_ID = config("CHANNEL_ID", default=0)
LOG_CHANNEL = config("LOG_CHANNEL", default=0, cast=int)
TESTS_CHANNEL = config("TESTS_CHANNEL", default=0, cast=int)
